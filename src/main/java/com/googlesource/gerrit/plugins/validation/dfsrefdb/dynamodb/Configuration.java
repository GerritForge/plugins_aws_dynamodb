...
class Configuration {
  ...
  private static final String DEFAULT_REFS_DB_TABLE_NAME = "refsDb";
  private static final String DEFAULT_LOCKS_TABLE_NAME = "lockTable";
  ...
  public String getRefsDbTableName() {
